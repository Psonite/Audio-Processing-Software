...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DelayPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=DelayPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DelayPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DelayPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DelayPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=DelayPlugin installer\n"
