...
def main():
  ...
  plistpath = scriptpath + "/resources/FlangerPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FlangerPlugin-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/FlangerPlugin-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/FlangerPlugin-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/FlangerPlugin-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/FlangerPlugin.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/FlangerPlugin.iss",inplace=1):
