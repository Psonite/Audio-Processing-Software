...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=CompressorPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=CompressorPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the CompressorPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the CompressorPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=CompressorPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=CompressorPlugin installer\n"
