...
def main():
  ...
  plistpath = scriptpath + "/resources/CompressorPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CompressorPlugin-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/CompressorPlugin-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/CompressorPlugin-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/CompressorPlugin-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/CompressorPlugin.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/CompressorPlugin.iss",inplace=1):
