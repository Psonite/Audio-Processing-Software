...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DistortionPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=DistortionPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DistortionPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DistortionPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DistortionPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=DistortionPlugin installer\n"
